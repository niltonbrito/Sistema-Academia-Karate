...
public class SwingFrm {
    ...
    AtletaMD atletaMB = new AtletaMD();
    ...
    public void setCmbFaixaAtleta() {
        ...
        if (jRadioBtnDangayAtleta.isSelected()) {
            cmbFaixaAtleta.setModel(new javax.swing.DefaultComboBoxModel(new String[]{"", "AMARELA", "VERMELHA", "LARANJA", "VERDE", "ROXA", "MARROM",}));
        } else {
    ...
    public void setCmbClubeAtleta() {
        if (jRadioBtnCbkscAtleta.isSelected()) {
            cmbClubeAtleta.setModel(new javax.swing.DefaultComboBoxModel(new String[]{"", "DA BAHIA", "DE GOIÁS", "DE MINAS GERAIS", "DE PERNAMBUCO", "DE SÃO PAULO", "DE TOCANTINS", "DO DISTRITO FEDERAL", "DO PARÁ", "DO RIO DE JANEIRO", "DO RIO GRANDE DO SUL"
            }));
        } else {
    ...
    public void setCmbFaixaExame() {
        if (jRadioBtnDangayExame.isSelected()) {
            cmbFaixaExame.setModel(new javax.swing.DefaultComboBoxModel(new String[]{"", "AMARELA", "VERMELHA", "LARANJA", "VERDE", "ROXA", "MARROM",}));
        } else {
    ...
    public void setCmbClubeExame() {
        if (jRadioBtnCBKSCExame.isSelected()) {
            cmbClubeExame.setModel(new javax.swing.DefaultComboBoxModel(new String[]{"", "DA BAHIA", "DE GOIÁS", "DE MINAS GERAIS", "DE PERNAMBUCO", "DE SÃO PAULO", "DE TOCANTINS", "DO DISTRITO FEDERAL", "DO PARÁ", "DO RIO DE JANEIRO", "DO RIO GRANDE DO SUL"
            }));
        } else {
