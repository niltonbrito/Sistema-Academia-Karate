...
public class AtletaBS {
    ...
    public void adicionarAtleta() {
        ...
        if (atletaMD.getIdAtleta().isEmpty()
            ...
            atletaMD.setTipoAtleta("INSERT INTO tb_atletas(id_dangay, id_yudansha, id_cbksc, nome_atleta, cpf_atleta, sexo_atleta, data_nasc_atleta, idade_atleta, clube_atleta, faixa_atleta, categoria_atleta, data_cadastro_atleta,nome_abreviado_atleta) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)");
    ...
    public void editarAtleta() {
        ...
        if (atletaMD.getIdAtleta().isEmpty()
            ...
            if (confirma == JOptionPane.YES_OPTION) {
                ...
                atletaMD.setTipoAtleta("update tb_atletas set " + tipo + "=?,nome_atleta=?, cpf_atleta=?,sexo_atleta=?,data_nasc_atleta=?,idade_atleta=?,clube_atleta=?,faixa_atleta=?,categoria_atleta=?,data_atualizacao_atleta=?, nome_abreviado_atleta=? where id_atleta=?");
    ...
    public void gerarId() {
        ...
        if (jRadioBtnDangayAtleta.isSelected()) {
            ...
            if (txtIdCbksc.getText().equals("0") || txtIdCbksc.getText().equals("")) {
                txtIdAtleta.setEditable(true);
                txtIdAtleta.setText("");
                atletaMD.setIdAtleta(txtIdAtleta.getText());
            } else {
                txtIdAtleta.setText(txtIdCbksc.getText());
                atletaMD.setIdAtleta(txtIdAtleta.getText());
            }
        }
    ...
    public void setarTipoCadastro() {
        try {
            String clube = tabelaAtleta.getModel().getValueAt(atletaDao.resultado, 8).toString();
            ...
            if (clube.equals("DA BAHIA")
                ...
                jRadioBtnCbkscAtleta.setSelected(true);
                cmbClubeAtleta.setSelectedItem(tabelaAtleta.getModel().getValueAt(atletaDao.resultado, 8).toString());
