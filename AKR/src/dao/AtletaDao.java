...
public class AtletaDao {
    ...
    public void adicionarAtleta(AtletaMD atletaMD) {
        try {
            ...
            statement.setString(11, atletaMD.getCategoria());
            statement.setString(12, dataAtual());
            statement.setString(13, atletaMD.getAbreviado());
    ...
    public void editarAtleta(AtletaMD atletaMD) {
        ...
        try {
            ...
            statement.setString(9, atletaMD.getCategoria());
            statement.setString(10, dataAtual());
            statement.setString(11, atletaMD.getAbreviado());
            statement.setString(12, atletaMD.getId());
    ...
    public void setarCampos() {
        try {
            ...
            txtCategoria.setText(tabelaAtleta.getModel().getValueAt(resultado, 10).toString());
            txtDataCad.setText(tabelaAtleta.getModel().getValueAt(resultado, 11).toString());
            txtId.setText(tabelaAtleta.getModel().getValueAt(resultado, 13).toString());
        } catch (Exception e) {
            erro = e.getMessage();
        } finally {
            try {
